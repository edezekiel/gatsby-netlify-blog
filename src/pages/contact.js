      ...
      <section className="skinny">
        ...
        <article>
          <p>
            ...
            from Flatiron's immersive software engineering bootcamp in Atlanta.
          ...
          <h2>Programming</h2>
          <p>
            My passion for coding began when I was working at UnitedLex. I
            managed document review projects involving millions of files. In
            order to streamline my workflow, I picked up computer skills like
            performing advanced database queries, writing excel programs, and
            creating virtual workspaces.
          </p>

          <p>
            I discovered macros, Visual Basic, and keyboard shortcuts that
            seemed like magic. Excel programming and querying was fun, but I
            became curious about the broader field of programming. Over the next
            two years I took more online lessons, learned bits about computer
            science, and started looking into bootcamps.
          </p>
